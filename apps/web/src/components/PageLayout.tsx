  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div style={{ flex: 1, minWidth: 0, height: '100%', display: 'flex', flexDirection: 'column' }}>
        ...
        {toolbar && (
          <div style={{ padding: '8px 12px', borderBottom: `1px solid ${colors.dividerSubtle}`, background: colors.toolbarGlassBg, backdropFilter: effects.toolbarBackdrop, position: 'relative', zIndex: 40 }}>
            {toolbar}
          </div>
        )}
